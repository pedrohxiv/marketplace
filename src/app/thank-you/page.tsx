...
const ThankYouPage = async ({ searchParams }: ThankYouPageProps) => {
  ...
  return (
    <main className="relative lg: max-h-full">
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:ga´x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              ...
              <p className="mt-2 text-base text-muted-foreground">
                We appreciate your order, and we&apos;re currenctly processing
                it. So hang tight and we&apos;ll send your confimation very
                soon!
              </p>
            )}
