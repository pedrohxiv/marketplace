...
const ReceiptEmail = ({
  ...
  const totalPrice =
    products.reduce((total, product) => total + product.price, 0) + fee;
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
            ...
            <Column style={productPriceWrapper} align="right">
              <Text style={productPrice}>{formatPrice(fee)}</Text>
            </Column>
          </Section>
          ...
          <Section align="right">
            ...
            <Column style={productPriceLargeWrapper}>
              <Text style={productPriceLarge}>{formatPrice(totalPrice)}</Text>
            </Column>
          </Section>
